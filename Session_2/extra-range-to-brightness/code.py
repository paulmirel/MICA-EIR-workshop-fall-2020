...
while True:
    ...
    brightness_minimum = 0.0
    brightness_maximum = 0.5

    brightness = simpleio.map_range(distance_mm, distance_mm_minimum, distance_mm_maximum, brightness_minimum, brightness_maximum)
